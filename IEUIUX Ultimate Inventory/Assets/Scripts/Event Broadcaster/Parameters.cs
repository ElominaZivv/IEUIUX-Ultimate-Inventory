...
public class Parameters
{
	...
	public Parameters()
	{
		...
		this.itemData = new Dictionary<string, Item>();
	}
	...
	public void PutExtra(string paramName, Item item)
	{
		this.itemData.Add(paramName, item);
	}
	...
	public Item GetItemExtra(string paramName)
	{
		if (this.itemData.ContainsKey(paramName))
		{
			return this.itemData[paramName];
		}
		else
		{
			return null;
